...
Lorsque vous lancez Chloros et Chloros (navigateur) pour la première fois, leur backend démarre. Une fois prêt, l&#x27;icône du menu principal en haut à gauche apparaît. <img src=".gitbook/assets/image (1) (1) (1).png" alt="" data-size="line"> .
...
Le menu latéral gauche contient diverses icônes avec lesquelles vous pouvez interagir :
...
Ajoutez des fichiers/dossiers et supprimez des fichiers du projet. Les fichiers en double sont ignorés. Cochez la case de la colonne cible pour toute image cible, et le traitement ne prendra en compte que les images cochées comme cibles, ce qui accélérera considérablement votre temps de traitement. Utilisez le bouton Image/Métadonnées pour basculer entre l&#x27;affichage de la grille de vignettes de l&#x27;image sélectionnée et un tableau détaillé des métadonnées.
...
Affichez vos images sur une carte 2D interactive en fonction de leurs coordonnées GPS. Prend en charge les fournisseurs de tuiles Google Maps et ESRI, en sélectionnant automatiquement le meilleur service pour votre emplacement. Passez la souris sur les marqueurs pour voir les aperçus des vignettes des images.

#### <img src=".gitbook/assets/icon_log.JPG" alt="" data-size="line"> Journal de débogage

Consultez le journal pour les impressions de débogage lorsque des problèmes surviennent. Copiez/téléchargez le journal et envoyez-le à [MAPIR Support](https://www.mapir.camera/community/contact) pour obtenir de l&#x27;aide.

#### <img src=".gitbook/assets/icon_user.JPG" alt="" data-size="line"> [Connexion utilisateur](chloros+-login.md)

La barre latérale de connexion utilisateur vous permet de vous connecter à votre compte Chloros+ pour débloquer des fonctionnalités avancées. Vous pouvez également consulter la version actuelle de l&#x27;application et régler la langue du texte affiché dans l&#x27;interface graphique Chloros et CLI.
