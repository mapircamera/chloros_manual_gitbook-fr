...
{% hint style=&quot;info&quot; %}
**Accélération GPU** : les utilisateurs de Chloros+ équipés de GPU NVIDIA (4 Go+ de VRAM) peuvent utiliser l&#x27;accélération CUDA pour un traitement nettement plus rapide.
{% endhint %}
...
**Configuration requise** : Chloros Desktop doit être installé, licence Chloros+ requise.
