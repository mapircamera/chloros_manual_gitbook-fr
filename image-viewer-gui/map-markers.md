...
Chaque image avec des données GPS est représentée par un marqueur sur la carte :

### Affichage des marqueurs

* Les marqueurs indiquent les coordonnées GPS exactes où chaque image a été capturée.
* Les marqueurs regroupés peuvent être regroupés lorsque vous effectuez un zoom arrière.
